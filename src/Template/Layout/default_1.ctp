...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <li>
                <a href="index.html"><span class="fa fa-files-o"></span> <span class="xn-text">PIM</span></a>
            </li>
            <li>
                <a href="index.html"><span class="fa fa-th"></span> <span class="xn-text">Leave</span></a>
            </li>
            <li>
                <a href="index.html"><span class="fa fa-dot-circle-o"></span> <span class="xn-text">Recruitment</span></a>
            </li>
            <li>
                <a href="index.html"><span class="fa fa-check-square-o"></span> <span class="xn-text">Performance</span></a>
            </li>
            <li>
                <a href="index.html"><span class="fa fa-credit-card"></span> <span class="xn-text">Payroll</span></a>
            </li>
            <li>
                <a href="index.html"><span class="fa fa-cogs"></span> <span class="xn-text">Admin</span></a>
            </li>
        </ul>
        <!-- END X-NAVIGATION -->
    </div>
